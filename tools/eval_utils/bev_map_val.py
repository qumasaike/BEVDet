...
def get_map(detpath, annopath, imagesetfile):
    # 检测的值要从真值里面找id
    ...
    # detpath  = '/home/mayechi/Work/Research/code/Super-Fast-Accurate-3D-Object-Detection/result/zhijiangyihao/{:s}.txt'
    # annopath = '/home/mayechi/Work/Research/code/Super-Fast-Accurate-3D-Object-Detection/dataset/zhijiangyihao/first_stage/training/label_for_val/{:s}.txt'
    # imagesetfile = '/home/mayechi/Work/Research/code/Super-Fast-Accurate-3D-Object-Detection/dataset/zhijiangyihao/first_stage/training/ImageSets/val_id.txt'
    ...
    # classnames = ['3']
    # ovthresh_list = [0.7, 0.3, 0.3, 0.3, 0.3, 0.3]
    classaps = []
    map = 0
